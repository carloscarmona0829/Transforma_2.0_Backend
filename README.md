...
4. Para correr el proyecto usar el comando "npm run local" y para validar que el back si subió, en una ventana de navegador digita http://localhost:8000 y si todo subió bien, debería aparecer algo como... "Cannot GET /"
