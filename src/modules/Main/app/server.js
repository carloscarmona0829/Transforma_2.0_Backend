        ...
        if (app.get("typeServer") === "dev") {
            ...
            this.#objServer = https
                .createServer(
                    {
                        key: fs.readFileSync(
                            "/var/www/transforma-api.demismanos.org/ssl/transforma-api.demismanos.org.key"
                        ),
                        cert: fs.readFileSync(
                            "/var/www/transforma-api.demismanos.org/ssl/transforma-api.demismanos.org.crt"
                        ),
                    },
                    app
                )
